...
class RoomForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'title': forms.TextInput(attrs={'placeholder': 'e.g., Modern Studio in Downtown', 'class': 'form-control', 'required': True}),
            ...
            'price': forms.NumberInput(attrs={'placeholder': 'e.g., 15000', 'class': 'form-control', 'required': True}),
            'contact_phone': forms.TextInput(attrs={'placeholder': '+91 98765 43210', 'class': 'form-control', 'required': True}),
